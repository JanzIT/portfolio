...
export const HeroSection = () => {
  return (
    ...
    >
      <div className="container max-w-4xl mx-auto text-center z-10">
        <div className="space-y-6">
          ...
          <p className="text-lg md:text-xl text-muted-forground max-2-2xl mx-auto opacity-0 animate-fade-in-delay-3">
            ...
            Fullstack Developer and Software Engineering student, I build
      ...
      <div className="absolute bottom-8 left-/12 transform -translate-x-1/2 flex flex-col items-center animate-bounce">
